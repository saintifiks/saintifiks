  ...
  return (
    <>
      ...
      <button
        ...
        type="button"
        onClick={handleOpen}
        className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full border border-ink/30 text-ink/60 hover:border-ink hover:text-ink transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-interactive-primary"
      ...
      {isOpen && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="opinion-share-dialog-title"
          tabIndex={-1}
        >
          {/* Backdrop */}
          <div
          ...
          {/* Sheet */}
          <div className="relative bg-paper w-full rounded-t-2xl shadow-2xl">
            {/* Handle bar */}
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-ink/10">
              ...
              <button
                ...
                aria-label="Tutup bagikan artikel"
              >
                <X size={18} />
              </button>
            </div>
            ...
            <div className="px-5 pt-5 pb-4 grid grid-cols-4 gap-3">
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-3 hover:bg-ink/5 rounded-xl transition-colors disabled:opacity-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-interactive-primary"
              >
                {isGenerating ? (
                  <Loader2 size={28} className="animate-spin text-ink/60" />
                ) : (
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-ink/70">
                    <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                    <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/>
                  </svg>
                )}
                <span className="font-helvetica text-xs text-ink/60 text-center leading-tight">
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-3 hover:bg-ink/5 rounded-xl transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-interactive-primary"
              >
                <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" className="text-ink/70">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
                <span className="font-helvetica text-xs text-ink/60">Twitter</span>
              </button>
              ...
              >
                ...
                <span className="font-helvetica text-xs text-ink/60">WhatsApp</span>
              </button>
              ...
              >
                ...
                <span className="font-helvetica text-xs text-ink/60">Facebook</span>
              </button>
            </div>
            ...
            <div className="px-5 pb-6">
              <button
                ...
                className="w-full min-h-[44px] flex items-center justify-center gap-2 py-3 border border-ink/15 hover:bg-ink/5 transition-colors font-helvetica text-sm text-ink/70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-interactive-primary"
              >
                <Link2 size={16} />
      ...
      {showPreview && (
        <div className="fixed -left-[9999px] top-0" aria-hidden="true">
          <div
            ref={storyRef}
            className="w-[1080px] h-[1920px] bg-ink flex flex-col items-center justify-center p-16 relative overflow-hidden"
          ...
          >
            ...
            <div className="z-10 text-center">
              {/* Quote mark */}
              <p className="text-paper/20 text-9xl leading-none mb-8">&ldquo;</p>

              {/* Judul — ukuran identik dengan ShareButton editorial */}
              <h1
                className="text-paper text-6xl leading-tight font-bold mb-12"
                style={{
                  display: '-webkit-box',
                  WebkitLineClamp: 5,
              ...
              <p className="font-helvetica text-2xl text-paper/60 mb-4">
                oleh <span className="text-paper font-medium">{authorDisplayName}</span>
              </p>

              {/* Badge Opinions — di bawah nama penulis */}
              <div className="flex justify-center mb-10">
                <span className="font-helvetica text-sm tracking-[0.25em] uppercase text-paper/50 border border-paper/20 px-4 py-1.5">
                  Opinions · Saintifiks
                </span>
              </div>
              ...
              {articleExcerpt && (
                <p
                  className="text-paper/70 text-2xl leading-relaxed mb-16 max-w-3xl mx-auto"
                  style={{
                    display: '-webkit-box',
                    WebkitLineClamp: 3,
                    WebkitBoxOrient: 'vertical',
              ...
              {/* CTA */}
              <div className="mt-12">
                <p className="font-helvetica text-base text-paper/50 tracking-wider uppercase mb-4">
            ...
            <div className="absolute bottom-20 left-0 w-full px-16">
              <div className="flex items-center justify-between">
                <p className="font-helvetica text-sm text-paper/40">
