...
// Footer Desktop — layout horizontal 3-kolom untuk layar besar
// Hanya muncul di breakpoint ≥ lg (min-width: 1024px)
...
function IconInstagram({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <g clipPath="url(#clipInstaDesktop)">
...
export default function FooterDesktop() {
  // Reverse order untuk desktop: Keamanan (kiri), Integritas (tengah), Tentang (kanan)
  const reversedNav = [...footerNavigation].reverse();
