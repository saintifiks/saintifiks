...
export default function ShareButton({ articleId, articleTitle, articleExcerpt, articleSlug }: ShareButtonProps) {
  ...
  return (
    <>
      ...
      <button
        onClick={handleOpen}
        className="flex items-center justify-center w-10 h-10 rounded-full border border-ink/30 text-ink/60 hover:border-ink hover:text-ink transition-colors duration-150"
        ...
        >
          ...
          <div className="relative bg-paper w-full rounded-t-2xl shadow-2xl">
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-ink/10">
              <h3 className="font-libre text-lg font-bold text-ink">Bagikan Artikel</h3>
              <button
                onClick={() => setIsOpen(false)}
            ...
            <div className="px-5 pt-5 pb-4 grid grid-cols-4 gap-3">
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-3 hover:bg-ink/5 rounded-xl transition-colors disabled:opacity-50"
              >
                {isGenerating ? (
...
onClick={() => handleShare('twitter')}
                 className="flex flex-col items-center gap-2 p-3 hover:bg-ink/5 rounded-xl transition-colors"
              >
...
onClick={handleCopyLink}
                 className="w-full flex items-center justify-center gap-2 py-3 border border-ink/15 hover:bg-ink/5 transition-colors font-helvetica text-sm text-ink/70"
              >
                <Link2 size={16} />
